...
{
if (Application->MessageBox("Czy na pewno zakoñczyæ gre?","Zakañczanie gry Piorun VS Serce", MB_YESNO |MB_ICONQUESTION) == IDYES)
        {
...
{
 if (Application->MessageBox("Czy na pewno zakoñczyæ gre?","Zakañczanie gry Piorun VS Serce", MB_YESNO |MB_ICONQUESTION) == IDNO)
        {
         Action=caNone;
        }
}
